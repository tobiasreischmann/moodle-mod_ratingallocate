...
class ratingallocate_choice_status implements renderable {
    ...
    public $allocations;
    public $strategy;
    /** @var bool showdistributioninfo specifies if the info regarding the distribution should be displayed. **/
    public $showdistributioninfo;
    /** @var bool showuserinfo specifies if the current ratings of the user shoulld be renderer. **/
    public $showuserinfo;

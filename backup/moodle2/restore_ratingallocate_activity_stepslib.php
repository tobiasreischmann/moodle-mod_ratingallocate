...
class restore_ratingallocate_activity_structure_step extends restore_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        $choicespath = $ratingallocatepath . '/' .
            this_db\ratingallocate_choices::TABLE . 's/' . this_db\ratingallocate_choices::TABLE;
        ...
        if ($userinfo) {
            $paths[] = new restore_path_element(
                this_db\ratingallocate_ratings::TABLE,
                    $choicespath .'/' . this_db\ratingallocate_ratings::TABLE .'s/' .
                    this_db\ratingallocate_ratings::TABLE);
            $paths[] = new restore_path_element(
    ...
    protected function process_ratingallocate($data) {
        ...
        $data->{this_db\ratingallocate::TIMECREATED} = $this->apply_date_offset(
            $data->{this_db\ratingallocate::TIMECREATED});
        $data->{this_db\ratingallocate::TIMEMODIFIED} = $this->apply_date_offset(
            $data->{this_db\ratingallocate::TIMEMODIFIED});
        $data->{this_db\ratingallocate::ACCESSTIMESTART} = $this->apply_date_offset(
            $data->{this_db\ratingallocate::ACCESSTIMESTART});
        $data->{this_db\ratingallocate::ACCESSTIMESTOP} = $this->apply_date_offset(
            $data->{this_db\ratingallocate::ACCESSTIMESTOP});
        $data->{this_db\ratingallocate::PUBLISHDATE} = $this->apply_date_offset(
            $data->{this_db\ratingallocate::PUBLISHDATE});
        $userinfo = $this->get_setting_value('userinfo');
        if (!$userinfo) {
    ...
    protected function process_ratingallocate_ratings($data) {
        ...
        $data->{this_db\ratingallocate_ratings::USERID} = $this->get_mappingid('user',
    ...
    protected function process_ratingallocate_allocations($data) {
        ...
        $data->{this_db\ratingallocate_allocations::USERID} = $this->get_mappingid('user',
